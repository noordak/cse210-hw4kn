// Scripture memorizer program, take 5
...
class Program
{
    static void Main(string[] args)
    {
        // Create some scriptures (you can add more from the Bible or Book of Mormon)
        ...
        while (!currentScripture.AllWordsHidden())
        {
            ...
            currentScripture.HideRandomWords(3); // Hide 3 random words per step
        }
